...
![image-20220403114709581](images/202204031147714.png)
...
![image-20220403115232833](images/202204031152952.png)

![image-20220403115249492](images/202204031152607.png)

![image-20220403115300809](images/202204031153931.png)
...
![image-20220404091224993](images/202204040912119.png)

**2. redo** **日志写入log buffer**

不同的事务可能是`并发`执行的，所以`事务T1`、`事务T2`之间的`mtr`可能是`交替执行`的。

![image-20220404091511602](images/202204040915708.png)
...
![image-20220404092038421](images/202204040920532.png)

**3. checkpoint**

![image-20220404092106617](images/202204040921715.png)
...
![image-20220404093706650](images/202204040937761.png)

**有了Redo Log和Undo Log之后：**

![image-20220404093832512](images/202204040938657.png)

**2.** **详细生成过程**

![image-20220404093950136](images/202204040939231.png)
...
![image-20220404094033441](images/202204040940543.png)

**当我们执行UPDATE时：**

![image-20220404094105525](images/202204040941624.png)

```mysql
UPDATE user SET id=2 WHERE id=1;
```

![image-20220404094142337](images/202204040941449.png)
...
![image-20220404094436830](images/202204040944948.png)
