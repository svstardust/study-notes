...
当我们编写一个类时，其实就是在描述其对象的属性和行为，而并没有产生实质上的对象，只有通过 new 关键字才会产生出对象，这时系统才会分配[内存](https://so.csdn.net/so/search?q=%E5%86%85%E5%AD%98&spm=1001.2101.3001.7020)空间给对象，其方法才可以供外部调用。

我们有时候希望无论是否产生了对象或无论产生了多少对象的情况下，**某些特定的数据在内存空间里只有一份。**

例如所有的中国人都有个国家名称，每一个中国人都共享这个国家名称，不必在每一个中国人的实例对象中都单独分配一个用于代表国家名称的变量。

![](assets/2057c0097587294fd28906287961f445-20220603152646-upcypbd.png)
...
![](assets/97cc52e6668ddb59b0a2fc1d63b99607-20220603152646-hwiqj6p.png)
...
[设计模式](https://so.csdn.net/so/search?q=%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F&spm=1001.2101.3001.7020)是**在大量的实践中总结和理论化之后优选的代码结构、编程风格、以及解决问题的思考方式。**设计模免去我们自己再思考和摸索。就像是经典的棋谱，不同的棋局，我们用不同的棋谱。”套路”
...
由于单例模式只生成一个实例， **减少了系统性能开销** ，当一个对象的产生需要比较多的资源时，如读取配置、产生其他依赖对象时，则可以通过在应用启动时直接产生一个单例对象，然后永久驻留内存的方式来解决。  
 ![](assets/5b12c0fa376f3b691fe7b660b1d73baf-20220603152646-p40841i.png)
...
![](assets/433e2dc60420147446a1954fc80dff97-20220603152646-v5pcoex.png)
...
![](assets/35c39171e6d8d7a2a25bd0c9edd48ee9-20220603152646-mbwr8ic.png)
...
## 05、抽象类与[抽象方法](https://so.csdn.net/so/search?q=%E6%8A%BD%E8%B1%A1%E6%96%B9%E6%B3%95&spm=1001.2101.3001.7020)

随着继承层次中一个个新[子类](https://so.csdn.net/so/search?q=%E5%AD%90%E7%B1%BB&spm=1001.2101.3001.7020)的定义，类变得越来越具体，而父类则更一般，更通用。类的设计应该保证父类和子类能够共享特征。有时将一个父类设计得非常抽象，以至于它没有具体的实例，这样的类叫做 **抽象类** 。

![](assets/367a5bc4e1045fec15a665827ad1a665-20220603152646-7s9i783.png)
...
![](assets/fae4ad700aef40c0402a7e092da91106-20220603152646-9vjnrb9.png)
...
![](assets/a36e51e665b20673f270cb9b2b921e20-20220603152646-w5mzy3n.png)  
 ![](assets/56ace48e046b22da15db7100a2edfccb-20220603152646-yxp6nmn.png)
 ...
 **接口的本质是契约，标准，规范** ，就像我们的法律一样。制定好后大家都要遵守。  
 ![](assets/aec8823d72652f568ac820b927069e4e-20220603152646-3bwlkow.png)
...
![](assets/729b5a0b77e2881568a2c029920e0f2e-20220603152646-bvvhsd1.png)
...
![](assets/1c9cab10d5aac0ca205e787df6f7bed2-20220603152646-c8bbivz.png)  
 ![](assets/e0c3ab2a9f72d5c2aaaca773adc0017d-20220603152646-68j2lw9.png)
...
![](assets/6be3acfe541841343c9338f669a58d0c-20220603152646-spweigg.png)
...
![](assets/6593e549625053470aca56f338387d98-20220603152646-dep794b.png)
